  ...
  return (
    ...
    >
      ...
      <path
        ...
        className={
          selected ? "stroke-sky-500" : "stroke-green-400 dark:stroke-green-500"
        }
      />
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        ...
        className={
          selected ? "fill-sky-500" : "fill-green-400 dark:fill-green-500"
        }
      />
      <path
        fillRule="evenodd"
            ...
            {({ active, selected }) => (
              <li
                className={clsx(
                  ...
                  active && "bg-green-50 dark:bg-green-600/30"
                )}
              >
