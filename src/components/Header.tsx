...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky inset-x-0 top-0 z-50 flex items-center justify-between bg-white py-2 px-2 shadow-lg dark:bg-slate-900/75 sm:py-3 sm:px-8">
        <MenuPopOver
      ...
      >
        ...
        >
          ...
          <div className="fixed top-0 bottom-0 left-0 w-full max-w-xs rounded-r-xl bg-white p-6 shadow-lg dark:bg-gray-800 ">
            ...
            <ul className="mt-10 space-y-3 border-t border-gray-200 dark:border-gray-200/10">
              <li>
                <br></br>
                <Button
                  variant="solid"
