      ...
      <div className="relative m-auto  w-[340px] sm:w-[480px] md:w-[490px] lg:w-[800px]">
        <div className="m-auto mt-16 mb-16 w-[340px] sm:w-[400px] md:w-[490px] lg:w-[800px]">
          <div className="relative">
            ...
            {/* circle one */}
            <div
              className="absolute top-[30px] left-[200px] h-[36px] w-[36px] cursor-pointer  rounded-full 
             text-white sm:top-[36px] sm:left-[234px] sm:h-[42px] sm:w-[42px] md:top-[44px] md:left-[287px] md:h-[52px] 
             md:w-[52px] lg:left-[470px] lg:top-[72px]  lg:h-[83px] lg:w-[83px]"
            >
            ...
            {/* circle two */}
            <div
              className="absolute top-[104px] left-[275px] h-[36px] w-[36px] cursor-pointer  rounded-full 
             text-white sm:top-[125px] sm:left-[323px] sm:h-[42px] sm:w-[42px] md:left-[387px] md:top-[163px] md:h-[52px] 
             md:w-[52px] lg:left-[656px] lg:top-[253px]  lg:h-[83px] lg:w-[83px]"
            >
              <div className="group relative h-full w-full items-center ">
                {/* dropdown  */}
                <>
            ...
            {/* circle three */}
            <div
              className="absolute left-[283px] top-[213px] h-[36px] w-[36px] cursor-pointer  rounded-full 
             text-white sm:top-[241px] sm:left-[335px] sm:h-[42px] sm:w-[42px] md:left-[403px] md:top-[302px] md:h-[52px] 
             md:w-[52px] lg:left-[665px] lg:top-[479px]  lg:h-[83px] lg:w-[83px]"
            >
              <div className="group relative h-full w-full items-center ">
                {/* dropdown  */}
                <>
            ...
            {/* circle four */}
            <div
              className="absolute left-[204px] top-[289px] h-[36px] w-[36px] cursor-pointer
              rounded-full  text-white sm:top-[335px] sm:left-[234px]
             sm:h-[42px] sm:w-[42px]  md:top-[414px] md:left-[294px] md:h-[52px] md:w-[52px]
              lg:left-[477px] lg:top-[666px]  lg:h-[83px] lg:w-[83px]"
            >
              <div className="group relative h-full w-full items-center ">
                {/* dropdown  */}
                <>
            ...
            {/* circle five */}
            <div
              className="absolute top-[260px] left-[35px] h-[36px] w-[36px] cursor-pointer rounded-full
             text-white sm:top-[302px] sm:left-[39px] sm:h-[42px] sm:w-[42px] md:left-[49px] md:top-[372px] md:h-[52px] 
             md:w-[52px] lg:left-[81px] lg:top-[611px]  lg:h-[83px] lg:w-[83px]"
            >
              <div className="group relative h-full w-full items-center ">
                {/* dropdown  */}
                <>
